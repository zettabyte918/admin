...
export class Form3Page implements OnInit {
  ...
  label1: any="Punaise";
  label2: any="1er Passage";
  label3: any="Traitement de surface";
  label4: any="Placement de boites a souris";
  label5: any="Salle de bain";
  label6: any="Exit 100 pro Belgagri";
  label7: any="Ne pas nettoyer à 10 cm des plinthes."
  label8: any="";
  label9: any="0";
  label10: any="Virement";
  imagesform:any= [];
